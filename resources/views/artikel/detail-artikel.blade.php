                ...
                <div class="row">
                    ...
                    <div class="col-md-6 order-1 col-12 mb-3">
                        <div class="container-informasi">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <div><i class="bi bi-person"></i> {{$artikel_editor }}</div>
                                    <div><i class="bi bi-calendar"></i> {{\Carbon\Carbon::parse($artikel_date)->format('M, d Y')}}</div>
                                </div>
                                <div>
                        ...
                        <h1 class="title-artikel">{{$artikel_title}}</h1>
                            ...
                            <div class="dropdown d-inline-block">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end p-2" aria-labelledby="shareDropdown" style="min-width: auto;">
                                    <div class="d-flex gap-2 px-2">
                                        ...
                                        <!-- Twitter / X -->
                                        <a href="https://twitter.com/intent/tweet?url={{ urlencode(request()->fullUrl()) }}&text={{ urlencode($artikel_title ?? '') }}" target="_blank" class="btn btn-outline-info btn-sm text-info" title="Twitter">
                                            <i class="bi bi-twitter"></i>
                                        </a>
                                        <!-- WhatsApp -->
                                        <a href="https://wa.me/?text={{ urlencode(($artikel_title ?? '') . ' ' . request()->fullUrl()) }}" target="_blank" class="btn btn-outline-success btn-sm text-success" title="WhatsApp">
                    ...
                    <div class="col-md-6 order-2 col-12 mt-md-none mt-xl-none">
                        <div class="container-thubmnail-image">
                            <img src="{{ asset('storage/'.$artikel_thumbnail) }}" alt="gambar-berita" class="image-artikel img-fluid">
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <div class="content-artikel col-12">
            {!! $artikel_content !!}
        </div>
    </div>
</section>
...
<!-- pagination section -->
<section class="pagination-artikel-detail mb-3">
    <div class="container">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-center flex-wrap gap-1">
            ...
            <div class="card card-hover">
                <div class="card-body p-3">
                    <h6 class="date-artikel-pagination">{{\Carbon\Carbon::parse($artikel->berita_date)->format('M, d Y')}} September, 22 2025</h6>
                    <h3 class="title-news-pagination">
                        {{Str::limit($artikel->berita_title), 90}}
                    </h3>
                </div>
            </div>
            @empty
