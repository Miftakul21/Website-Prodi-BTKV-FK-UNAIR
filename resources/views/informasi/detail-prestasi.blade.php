                ...
                <div class="row">
                    ...
                    <div class="col-md-6 order-2 col-12 mt-md-none mt-xl-none">
                        <div class="container-thubmnail-image">
                            <img src="{{ asset('storage/'.$prestasi_thumbnail) }}" alt="gambar-berita" class="image-news img-fluid">
                        </div>
                    </div>
                </div>
            </div>
...
<section class="pagination-news-detail mb-3">
    <div class="container">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-center flex-wrap gap-1">
            @forelse($prestasi_lainnya as $berita)
            <div class="card card-hover">
                <div class="card-body p-3">
                    <h6 class="date-news-pagination">{{\Carbon\Carbon::parse($berita->prestasi_date)->format('M, d Y')}} September, 22 2025</h6>
                    <h3 class="title-news-pagination">
                        {{Str::limit($berita->prestasi_title), 90}}
                    </h3>
                </div>
            </div>
            @empty
